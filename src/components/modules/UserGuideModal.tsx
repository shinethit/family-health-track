...
const GUIDE_SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    summary: 'အက်ဒမင် (shinethitsmt@gmail.com) မှ လူနာအားလုံး၏ စာရင်းကို အချိန်နှင့်တပြေးညီ ကြည့်ရှုစောင့်ကြည့်ခြင်း',
    steps: [
      'အက်ဒမင် အီးမေးလ် (`shinethitsmt@gmail.com`) ဖြင့် Login ဝင်ရောက်ပါ',
