...
const GUIDE_SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'ဆရာဝန်/အထူးကုမှ ပြန်လည်ဖြေကြားထားသော အကြံပြုချက်များကို တိုက်ရိုက် ဖတ်ရှုနိုင်ပါသည်'
    ],
    tips: [
  ...
  {
    id: 'admin',
    title: '၆။ ဆေးခန်းနှင့် စနစ်စီမံခန့်ခွဲမှု (Clinic & System Management)',
    icon: ShieldCheck,
    category: 'စီမံခန့်ခွဲမှုနှင့် လုံခြုံရေး',
    summary: 'ဆရာဝန်နှင့် ကျန်းမာရေး ဝန်ထမ်းများအတွက် လူနာများ၏ သဘောတူခွင့်ပြုချက်ဖြင့် မှတ်တမ်းများ စစ်ဆေးပြီး အကြံပြုချက် ပေးပို့ခြင်း',
    steps: [
      'ဆေးခန်း/အက်ဒမင် အကောင့်ဖြင့် စနစ်အတွင်း ဝင်ရောက်ပါ',
      'လူနာ၏ သဘောတူခွင့်ပြုချက်ဖြင့် မှတ်တမ်းတင်ထားသော BP, Glucose, BMI နှင့် ဓာတ်ခွဲခန်းစစ်ဆေးချက်များကို Clinical Dashboard ဖြင့် စစ်ဆေးနိုင်ပါသည်',
      'လူနာထံသို့ သီးသန့် ဆေးဝါး/အစားအသောက် အကြံပြုချက်များ (Doctor Advice) ရေးသားပေးပို့နိုင်ပါသည်',
      'Firestore Free Quota & System Health တွင် အခမဲ့သုံးစွဲမှု ကန့်သတ်ချက်များကို အချိန်နှင့်တပြေးညီ စောင့်ကြည့်နိုင်ပါသည်'
    ],
    tips: [
      'လူနာအချက်အလက်များကို အဆင့်မြင့် လုံခြုံရေးစနစ်ဖြင့် ထိန်းသိမ်းထားပါသည်'
    ]
  },
  {
    id: 'pwa',
